...
If you installed the CLI globally (e.g., `npm install -g @salesforce/codey`), use the `npm uninstall` command with the `-g` flag to remove it.

```bash
npm uninstall -g @salesforce/codey
```
